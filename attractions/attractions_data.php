<?php
 include '../tourtzdb.php';
		/////////////// for displaying code according to the search from the search box///////////////////
    // $keyword = $_POST['keyword'];  
    // if(!empty($keyword)){
	 $search = mysqli_query($connection,"SELECT DISTINCT * FROM attractions, location where  attractions.location_id = location.location_id  ORDER BY attraction_category_name ASC ")  or die(mysqli_error());
