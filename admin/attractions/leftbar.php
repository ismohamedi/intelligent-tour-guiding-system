...
<!-- display image on profile leftpanell -->
               ...
               <!--     <li>
                     ...
                     <li  >
                        <a   href="attractions.php" style="background: #15677A"><i class="fa fa-table fa-3x"></i>Attractions</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level" style="background: #15677A">
                            <li>
                              ...
                              <form method="post" action="update_attractions.php" style="margin-left: 10%;" style="background: #15677A">
