...
<body>
        ...
        <div id="page-wrapper" style="overflow: scroll;" >
            <div id="page-inner" style="overflow: scroll;margin-top: 4%;">
                <div class="row" style="overflow: scroll;">
                    <div class="col-md-12">
                     <h2 align="center" style="color:#15677A"> Update Locations</h2>   
  ...
  <thead class="alert-info">
    <tr>
      <th scope="col" width="300" ><h3 align="center">Location ID</h3></th>
       <th scope="col" width="300"><h3 align="center">District</h3></th>
      <th scope="col" width="200"><h3 align="center">Region</h3></th>
      <th scope="col" width="200"><h3 align="center">Weather ID</h3></th>
