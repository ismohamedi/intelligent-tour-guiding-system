...
<!-- display image on profile leftpanell -->
               ...
               <!--     <li>
                     ...
                     <li  >
                      ...
                      <li  >
                        <a  href="accommodations.php" style="background: #15677A"><i class="fa fa-table fa-3x"></i>Accommodations</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level" style="background: #15677A">
                            ...
                            <li>
                              ...
                              <form method="post" action="update_accommodations.php" style="margin-left: 10%;">
