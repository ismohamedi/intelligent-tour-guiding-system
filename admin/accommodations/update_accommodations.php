...
<body>
        ...
        <div id="page-wrapper" style="overflow: scroll;" >
            <div id="page-inner" style="overflow: scroll;margin-top: 4%;">
                <div class="row" style="overflow: scroll;">
                    <div class="col-md-12">
                     <h2 align="center" style="color:#15677A"> accommodations</h2>   
  ...
  <thead class="alert-info">
    <tr>
      <th scope="col" width="300" ><h3 align="center">Accommodation ID</h3></th>
       <th scope="col" width="300"><h3 align="center">Accommodation Name</h3></th>
      <th scope="col" width="200"><h3 align="center">Accommodation category</h3></th>
  ...
  <tbody id="result"></tbody>
    ...
    <script src="../js/accommodation_script.js"></script>
